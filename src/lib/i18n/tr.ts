...
export const tr: Content = {
  ...
  robotChat: {
    ...
    chips: ["Kim bu Maksut?", "Neler yapabiliyor?", "Projeler", "Nasıl ulaşırım?"],
    fallbacks: ["hmm, bu benim devrelerimi aştı 🤖 'yetenekler', 'projeler' ya da 'iletişim' diyebilirsin.", "işlemcim bunu çözemedi ama şunu biliyorum: Maksut'a sormaya değer. 'iletişim' yaz yeter.", "404 — cevap bulunamadı. ama 'şaka' yazarsan telafi ederim."],
    intents: [
      { id: "greet", keywords: ["selam", "merhaba", "hey", "naber", "nasılsın", "günaydın", "iyi akşam"], responses: ["selam! devrelerim %100, kahve seviyem kritik ☕ sen nasılsın?", "merhaba insan! bugün 0 saldırı engelledim, sohbete vaktim bol."] },
      { id: "who-bot", keywords: ["kimsin", "nesin", "robot musun", "adın ne", "sen kim"], responses: ["ben NÖBETÇİ-BOT — bu sitenin köşe robotu. gözlerim imleci izler, ağzım laf yapar.", "Maksut'un el yapımı nöbetçisiyim. API yok, bulut yok — saf yerel zekâ (idare eder yani)."] },
      { id: "who-maksut", keywords: ["maksut", "sahibin", "kim bu", "hakkında", "tanıt"], responses: ["Maksut, İstanbul merkezli bir Bilgisayar Mühendisi — siber güvenlik, yazılım geliştirme ve otomasyon işleri yapıyor. Ocak 2026 mezunu, çalışmaya hazır! Detay: Hakkımda bölümü ⬆", "patronum mu? güvenlik meraklısı bir mühendis. nmap'le tarar, python'la otomatikleştirir, benim gibi robotlar yapar."] },
      { id: "skills", keywords: ["yetenek", "beceri", "neler yapabil", "stack", "teknoloji", "hangi dil"], responses: ["kısa liste: Kali Linux, Nmap, Metasploit, Wireshark, Python, Next.js/React, Unity C#, SAP PI/PO. uzun liste için Yetenekler bölümüne kaydır 🛠", "siber güvenlik + web + oyun + otomasyon. dört koldan. çiplerin üzerine fareyi götür, parlıyorlar bile."] },
      { id: "projects", keywords: ["proje", "yaptığı işler", "portföy", "neler yaptı"], responses: ["favorim Daily AI Researcher — her sabah 07:00'de bülten yazan tray uygulaması (beni de o ilhamla yaptılar). Projeler bölümünde 7 tanesi listeli 📂", "projeler bölümünde AI'dan Unity'ye 7 iş var; bir de NDA'lı gizli kayıtlar… onlar hakkında konuşamam 🤐"] },
      { id: "experience", keywords: ["deneyim", "staj", "tecrübe", "nerede çalış"], responses: ["üç staj: pentest (Kali/Nmap/Metasploit), SAP PI/PO entegrasyonu ve BT destek. saha görmüş biri yani. detay: Deneyim bölümü."] },
      { id: "contact", keywords: ["iletişim", "ulaş", "mail", "e-posta", "eposta", "mesaj at"], responses: ["İletişim bölümünde e-posta tek tıkla kopyalanıyor 📮 LinkedIn/GitHub da hemen altında. söyle geldiğini, kahve benden.", "aşağı in, İletişim, e-postayı kopyala. bu kadar basit. (kopyalarsan rozet de düşüyor, demedi deme)"] },
      { id: "cv", keywords: ["cv", "özgeçmiş", "resume"], responses: ["CV'nin Türkçe ve İngilizce sürümü en üstte, hero bölümündeki 'CV İndir' düğmesinde 📄"] },
      { id: "hire", keywords: ["işe al", "freelance", "fiyat", "ücret", "proje yaptır", "iş ver"], responses: ["Maksut freelance işlere açık! Freelancer/Upwork/Fiverr/Bionluk profilleri Freelance bölümünde. ciddi işler için e-posta en hızlısı 🤝"] },
      { id: "joke", keywords: ["şaka", "espri", "güldür", "komik"], responses: ["neden güvenlik duvarı terapiye gitmiş? çok fazla duvar örmüş 🧱", "udp şakası anlatırdım ama ulaşıp ulaşmadığını bilemem.", "- root musun? - hayır ama denedim: sudo make coffee, izin reddedildi ☕"] },
      { id: "hack", keywords: ["hack", "saldır", "sızma", "exploit"], responses: ["saldırı mı?! ...şaka, sistem güvende ✓ ama madem sordun, ekrana bir sürpriz bıraktım 🌧 yağıyor mu bak."] },
      { id: "badges", keywords: ["rozet", "başarım", "ipucu", "gizli", "easter"], responses: ["8 rozet var: bana tıkla ✓, 'hack' yaz, terminale 3 komut, tüm bölümleri gez, e-postayı kopyala, rozeti 5 kez çevir, SAKIN TIKLAMA'ya bas, benimle 5 mesajlaş 🏆"] },
      { id: "site", keywords: ["site", "nasıl yapıldı", "hangi teknoloji", "web sitesi"], responses: ["bu site el yapımı: Next.js 16 + Tailwind 4 + Framer Motion. tek renk, bol animasyon, nonce'lu CSP — güvenlikçinin sitesi böyle olur 🔒"] },
      { id: "thanks", keywords: ["teşekkür", "sağol", "eyvallah", "thanks"], responses: ["rica ederim! bip bop 🤖", "ne demek — nöbetteyim zaten."] },
      { id: "bye", keywords: ["görüşürüz", "bay", "bye", "hoşça kal", "kapan"], responses: ["görüşürüz insan! ben köşemde nöbete devam 👋 (fareyi oynatırsan gözlerim seni bulur)"] },
